    ...
    <section id="contact" className="mx-auto mt-28 max-w-5xl px-6 text-white">
      <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-white/0 p-10 backdrop-blur">
        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.35em] text-accent">Let&apos;s connect</p>
            <h2 className="mt-4 text-3xl font-semibold">Collaborate on secure, user-first products</h2>
            <p className="mt-6 text-sm text-white/70">
              Reach out at <a href="mailto:malcolm.ryu.dyer@gmail.com" className="text-accent hover:text-white">malcolm.ryu.dyer@gmail.com</a>
              or connect with me on <a href="https://linkedin.com/in/malcolm-dyer" className="text-accent hover:text-white" target="_blank" rel="noreferrer">LinkedIn</a>.
              Share a bit about the challenge you&apos;re tackling and I&apos;ll respond within two business days.
            </p>
          </div>
          <form className="space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                name="message"
                rows="4"
                placeholder="Tell me about your security goals, timeline, and success criteria."
                className="mt-2 w-full rounded-2xl border border-white/10 bg-white/10 px-4 py-3 text-sm text-white placeholder:text-white/40 focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/40"
              />
            </div>
            <button
